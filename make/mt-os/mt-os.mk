...
XI_CONST_PLATFORM_STM32F4 := stm32f4
XI_CONST_PLATFORM_STM32F4_NUCLEO_WIFI := stm32f4_nucleo_wifi
...
ifneq (,$(findstring $(XI_CONST_PLATFORM_STM32F4),$(TARGET)))
  XI_CONST_PLATFORM_CURRENT := $(XI_CONST_PLATFORM_STM32F4)
endif

ifneq (,$(findstring $(XI_CONST_PLATFORM_STM32F4_NUCLEO_WIFI),$(TARGET)))
  XI_CONST_PLATFORM_CURRENT := $(XI_CONST_PLATFORM_STM32F4_NUCLEO_WIFI)
endif
