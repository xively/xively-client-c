...
XI_COMPILER_FLAGS += -I$(LIBXIVELY)/build/include #TODO: This file was generated by the GUI in $(XI_ESP_IDF_SDK_PATH)/make/project.mk... We should probably include a pre-built one and get rid of that GUI somehow
...
#######################
#include $(XI_ESP_IDF_SDK_PATH)/make/project.mk
#XI_COMPILER_FLAGS += $(CFLAGS)
