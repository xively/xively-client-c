...
def tabs_2_spaces( s ):
   return s.replace( "\t", "    " )
h_pro               = tabs_2_spaces( "// Copyright (c) 2003-2017, LogMeIn, Inc. All rights reserved.\n// This is part of Xively C library." )
...
h_includes          = tabs_2_spaces( "#include \"xi_layer.h\"" )
...
unused              = tabs_2_spaces( "\tXI_UNUSED( data );" )
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser( description="libxively layer creator" )
    ...
    path = os.path.join( '.', 'src', 'libxively', name )
