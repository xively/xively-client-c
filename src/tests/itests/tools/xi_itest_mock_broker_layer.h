 ...
 * @brief   mock broker is used in integration tests for monitoring and driving libxively's behavior
 *
 ...
 * forwards it to mock io (which behaves like libxively's default io layer except of networking)
 ...
 */
xi_state_t xi_mock_broker_layer_push(
      void* context
    , void* data
    , xi_state_t state );
 ...
 * @brief   contains mock broker behavior, receives mqtt decoded messages from mock broker layer chain
 *
 ...
 * Instrumented function: can be monitored and driven by test case.
 */
xi_state_t xi_mock_broker_layer_pull(
      void* context
    , void* data
    , xi_state_t state );

xi_state_t xi_mock_broker_layer_close(
      void* context
    , void* data
    , xi_state_t state );

xi_state_t xi_mock_broker_layer_close_externally(
      void* context
    , void* data
    , xi_state_t state );
 ...
 */
xi_state_t xi_mock_broker_layer_init(
      void* context
    , void* data
    , xi_state_t state );
 ...
 * @brief   mock instrumented function to mimic different behaviours
 */
xi_state_t xi_mock_broker_layer_connect(
      void* context
    , void* data
    , xi_state_t state );
 ...
 * Instrumented function: can be monitored and driven by test case.
 */
xi_state_t xi_mock_broker_secondary_layer_push(
      void* context
    , void* data
    , xi_state_t state );

xi_state_t xi_mock_broker_secondary_layer_pull(
      void* context
    , void* data
    , xi_state_t in_out_state );

xi_state_t xi_mock_broker_secondary_layer_close(
      void* context
    , void* data
    , xi_state_t in_out_state );

xi_state_t xi_mock_broker_secondary_layer_close_externally(
      void* context
    , void* data
    , xi_state_t in_out_state );

xi_state_t xi_mock_broker_secondary_layer_init(
      void* context
    , void* data
    , xi_state_t in_out_state );

xi_state_t xi_mock_broker_secondary_layer_connect(
      void* context
    , void* data
    , xi_state_t in_out_state );
