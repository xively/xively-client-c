...
xi_state_t xi_driver_free_protobuf_callback( struct _XiClientFtestFw__XiClientCallback* callback );
...
xi_libxively_driver_t* xi_libxively_driver_create_instance()
{
    ...
    XI_CHECK_CND_DBGMESSAGE( driver->evtd_instance == NULL
        , XI_OUT_OF_MEMORY
        , state
    ...
    XI_CHECK_STATE( xi_create_context_with_custom_layers_and_evtd(
        &driver->context,
        xi_driver_control_channel_layerchain,
    ...
    XI_CHECK_CND_DBGMESSAGE( driver->context == NULL
        , XI_OUT_OF_MEMORY
        , state
...
#define XI_DRIVER_PROTOBUF_CREATE_DEFAULT_ON_HEAP( type, out_variable_name, stack_init, state ) \
    ...
    {                                                           \
        ...
        struct type out_variable_name_local = stack_init;       \
                                                                \
        memcpy( out_variable_name                               \
            , &out_variable_name_local                          \
            , sizeof( struct type ) );                          \
    }                                                           \


xi_state_t xi_libxively_driver_send_on_connect_finish(
      xi_libxively_driver_t* driver
    , xi_state_t connect_result )
{
    ...
    XI_DRIVER_PROTOBUF_CREATE_DEFAULT_ON_HEAP(
        _XiClientFtestFw__XiClientCallback,
        client_callback,
        XI_CLIENT_FTEST_FW__XI_CLIENT_CALLBACK__INIT,
        state );
    ...
    XI_DRIVER_PROTOBUF_CREATE_DEFAULT_ON_HEAP(
        _XiClientFtestFw__XiClientCallback__OnConnectFinish,
        on_connect_finish,
        XI_CLIENT_FTEST_FW__XI_CLIENT_CALLBACK__ON_CONNECT_FINISH__INIT,
        state );
...
xi_state_t xi_libxively_driver_send_on_disconnect(
      xi_libxively_driver_t* driver
    , xi_state_t error_code )
{
    ...
    XI_DRIVER_PROTOBUF_CREATE_DEFAULT_ON_HEAP(
        _XiClientFtestFw__XiClientCallback__OnDisconnect,
        on_disconnect,
        XI_CLIENT_FTEST_FW__XI_CLIENT_CALLBACK__ON_DISCONNECT__INIT,
        state );
...
xi_state_t xi_libxively_driver_send_on_publish_finish(
      xi_libxively_driver_t* driver
    , void* data
    , xi_state_t publish_result )
{
    ...
    XI_DRIVER_PROTOBUF_CREATE_DEFAULT_ON_HEAP(
        _XiClientFtestFw__XiClientCallback__OnPublishFinish,
        on_publish_finish,
        XI_CLIENT_FTEST_FW__XI_CLIENT_CALLBACK__ON_PUBLISH_FINISH__INIT,
        state );
