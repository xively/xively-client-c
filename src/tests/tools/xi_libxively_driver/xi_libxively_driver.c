...
int main( int argc, char const *argv[] )
{
    ...
    xi_libxively_driver_connect_with_callback(
          libxively_driver
    ...
    xi_evtd_step( libxively_driver->context->context_data.evtd_instance, xi_getcurrenttime_seconds() );

    xi_evtd_instance_t* evtd_all[ 2 ] = {
              xi_globals.evtd_instance
            , libxively_driver->context->context_data.evtd_instance
        };
