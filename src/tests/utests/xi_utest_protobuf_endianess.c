...
XIUTESTENDIANESS *
       xi__utest__endianess__unpack
                     (ProtobufCAllocator  *allocator,
                      ...
                      const uint8_t       *data)
{
    return (XIUTESTENDIANESS *)
      protobuf_c_message_unpack (&xi__utest__endianess__descriptor,
                                  allocator, len, data);
}
...
{
  {
    ...
    0,   /* quantifier_offset */
    offsetof(XIUTESTENDIANESS, test_value),
    NULL,
    NULL,
    0,             /* flags */
...
static const ProtobufCIntRange xi__utest__endianess__number_ranges[1 + 1] =
{
  { 1, 0 },
  { 0, 1 }
};
const ProtobufCMessageDescriptor xi__utest__endianess__descriptor =
{
  ...
  1,  xi__utest__endianess__number_ranges,
...
/* This is the length of the final encoded data that we're going to test serialization against. */
...
XI_TT_TESTCASE( utest__protobuf_endianess___pack,
{
    ...
    tt_want_int_op( predicted_packed_length, ==, xi_utest_protobuf_endianess_data_length );
