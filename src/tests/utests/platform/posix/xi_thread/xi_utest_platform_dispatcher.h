...
XI_TT_TESTCASE(
    utest__thread_safety_clash__entities_must_not_clash,
    {
        ...
        xi_event_handle_t evtd_handle
            = {XI_EVENT_HANDLE_ARGC1,
               .handlers.h1
               = {&register_evtd_handle, ( xi_event_handle_arg1_t )&evtd_g_i}};
        ...
        {
            tt_want_int_op( evtd_g_i->cs->cs_state, ==, 0 );
            xi_evtd_continue_when_evt_on_socket( evtd_g_i, XI_EVENT_WANT_READ,
                                                 evtd_handle, 12 );
            tt_want_int_op( evtd_g_i->cs->cs_state, ==, 0 );
...
XI_TT_TESTCASE(
    utest__thread_safety_clash_event_handler_on_stop__entities_must_not_clash,
    {
        ...
        xi_event_handle_t evtd_handle
            = {XI_EVENT_HANDLE_ARGC1,
               .handlers.h1
               = {&stop_evtd_handle, ( xi_event_handle_arg1_t )&evtd_g_i}};
        tt_assert( xi_evtd_register_socket_fd( evtd_g_i, 12, evtd_handle ) != 0 );
