...
/*****************************************************
 * SELECT_NEXT_RESOURCE_TO_DOWNLOAD ******************
 *****************************************************/

XI_TT_TESTCASE_WITH_SETUP(
    xi_utest__select_next_resource_to_download__null_context,
    xi_utest_setup_basic,
    xi_utest_teardown_basic,
    NULL,
    {
        xi_state_t state = _xi_sft_select_next_resource_to_download( NULL );
