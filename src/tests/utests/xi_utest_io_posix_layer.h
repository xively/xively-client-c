...
, XI_LAYER_TYPES_ADD( XI_LAYER_TYPE_MOCK_IO_NEXT,
                      ...
                      NULL ) XI_DECLARE_LAYER_TYPES_END()
      ...
      XI_TT_TESTGROUP_BEGIN( utest_io_posix_layer )
          ...
          XI_TT_TESTCASE_WITH_SETUP(
              ...
              NULL,
              {
                  ...
                  local_state = xi_find_handle_for_object(
                      xi_globals.context_handles_vector, xi_context, &xi_context_handle );
                  ...
                  for ( ; err_state < XI_ERROR_COUNT; ++err_state )
                  {
                      ...
                      xi_io_posix_layer_connect( layer_context, NULL,
                                                 ( xi_state_t )err_state );
                      ...
                      tt_int_op( xi_test_io_posix_next_conn_state, ==,
                                 ( xi_state_t )err_state );
                  }
