...
#ifdef XI_EXPOSE_FS
XI_TT_TESTCASE(
    utest__xi_set_fs_functions__correct_values,
    {
...
XI_TT_TESTCASE( utest__xi_fs_open__invalid_file_name__resource_not_availible_returned,
                {
                    ...
                    xi_state_t ret =
                        xi_fs_open( NULL, XI_FS_CONFIG_DATA,
...
XI_TT_TESTCASE( utest__xi_fs_read__invalid_resource_handle__invalid_parameter_returned,
                {
                    ...
                    xi_state_t ret =
                        xi_fs_read( NULL, resource_handle, 0, &buffer, &buffer_size );
