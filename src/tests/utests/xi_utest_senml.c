...
XI_TT_TESTCASE( utest_xi_senml_create__valid_data__create_structure_with_base_name,
{
    ...
    tt_want_ptr_op( structure, !=, 0 );
    tt_want_ptr_op( structure->base_name, !=, 0 );
    tt_want_int_op( memcmp( structure->base_name, test_name, sizeof( test_name ) ), ==, 0 );
    tt_want_int_op( structure->base_time, ==, 0 );
    tt_want_ptr_op( structure->base_units, ==, 0 );
    tt_want_ptr_op( structure->entries_list, ==, 0 );
...
XI_TT_TESTCASE( utest_xi_senml_create__valid_data__create_structure_with_base_units,
{
    ...
    XI_CREATE_SENML_STRUCT( state, structure, XI_SENML_BASE_UNITS( ( char* )test_units_name ) );

    tt_want_ptr_op( structure, !=, 0 );
    tt_want_ptr_op( structure->base_name, ==, 0 );
    tt_want_int_op( structure->base_time, ==, 0 );
    tt_want_int_op( memcmp( structure->base_units, test_units_name,
                            sizeof( test_units_name ) ), ==, 0 );
    tt_want_ptr_op( structure->entries_list, ==, 0 );
...
XI_TT_TESTCASE( utest_xi_senml_create__valid_data_create_structure_with_all_fields,
{
    ...
    tt_want_int_op( memcmp( structure->base_units, test_units_name,
                            sizeof( test_units_name ) ), ==, 0 );
    tt_want_int_op( memcmp( structure->base_name, test_name,
                            sizeof( test_name ) ), ==, 0 );
    tt_want_ptr_op( structure->entries_list, ==, 0 );
    tt_want_int_op( state, ==, XI_STATE_OK );
...
XI_TT_TESTCASE( utest_xi_senml_create_with_base_name_invalid_data__set_state_to_invalid_parameter,
{
    xi_senml_t* structure = 0;
    xi_state_t state = XI_STATE_OK;
...
XI_TT_TESTCASE( utest_xi_senml_create_with_base_units_invalid_data_set_state_to_invalid_parameter,
{
    xi_senml_t* structure = 0;
    xi_state_t state = XI_STATE_OK;
...
XI_TT_TESTCASE( utest_xi_senml_entry_create_float_value__valid_data__create_empty_structure_with_one_value_entry,
{
    xi_senml_t* structure = 0;
    xi_state_t state = XI_STATE_OK;
...
XI_TT_TESTCASE( utest_xi_senml_entry_create_string_value__valid_data_create_empty_structure_with_string_value_entry,
{
    xi_senml_t* structure = 0;
    xi_state_t state = XI_STATE_OK;
...
XI_TT_TESTCASE( utest_xi_senml_entry_create_boolean_value__valid_data_create_empty_structure_with_boolean_value_entry,
{
    xi_senml_t* structure = 0;
    xi_state_t state = XI_STATE_OK;
    uint8_t value = 1;
    ...
    XI_CREATE_SENML_EMPTY_STRUCT( state, structure );
    XI_ADD_SENML_ENTRY( state, structure,
                    XI_SENML_ENTRY_BOOLEAN_VALUE( value ) );
...
XI_TT_TESTCASE( utest_xi_senml_entry_create_time__valid_data_create_empty_structure_with_time_entry,
{
    xi_senml_t* structure = 0;
    xi_state_t state = XI_STATE_OK;
    uint32_t time = 1123;
    ...
    tt_want_int_op( structure->entries_list->time,
                        ==, time );
...
XI_TT_TESTCASE( utest_xi_senml_entry_create_updata_time__valid_data_create_empty_structure_with_update_time_entry,
{
    xi_senml_t* structure = 0;
    xi_state_t state = XI_STATE_OK;
    ...
    tt_want_int_op( structure->entries_list->update_time,
                        ==, update_time );
    ...
    xi_utest_setup_basic, xi_utest_teardown_basic, NULL,
{
    ...
    XI_CREATE_SENML_EMPTY_STRUCT( state, structure );
    XI_ADD_SENML_ENTRY( state, structure,
        XI_SENML_ENTRY_STRING_VALUE( "flow" ),
        XI_SENML_ENTRY_STRING_VALUE( "rope" ),
        XI_SENML_ENTRY_STRING_VALUE( "cukroscsibecombcsont" ) );

    tt_want_ptr_op( structure->entries_list, !=, NULL );
    tt_want_int_op( structure->entries_list->set.value_set, ==, 1 );
    tt_want_str_op( structure->entries_list->value_cnt.value.string_value, ==, "cukroscsibecombcsont" );
    ...
    xi_utest_setup_basic, xi_utest_teardown_basic, NULL,
{
    ...
    tt_want_ptr_op( structure->entries_list, !=, NULL );
    tt_want_int_op( structure->entries_list->set.value_set, ==, 1 );
    tt_want_str_op( structure->entries_list->value_cnt.value.string_value, ==, "rope" );
