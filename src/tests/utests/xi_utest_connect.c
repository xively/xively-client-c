...
XI_TT_TESTCASE_WITH_SETUP( test_INVALID_connect_context,
...
XI_TT_TESTCASE_WITH_SETUP( test_VALID_connect_context,
    xi_utest_setup_basic, xi_utest_teardown_basic, NULL,
{
    xi_state_t state;
...
XI_TT_TESTCASE_WITH_SETUP( test_connect_to__valid_host,
    xi_utest_setup_basic, xi_utest_teardown_basic, NULL,
{
    xi_state_t state;
...
XI_TT_TESTCASE_WITH_SETUP( test_connect_to__invalid_host,
    xi_utest_setup_basic, xi_utest_teardown_basic, NULL,
{
    xi_state_t state;
    ...
    xi_utest_setup_basic, xi_utest_teardown_basic, NULL,
{
    ...
    xi_context_handle_t xi_invalid_context = XI_INVALID_CONTEXT_HANDLE;
...
XI_TT_TESTCASE_WITH_SETUP( test_connect_lastwill,
    xi_utest_setup_basic, xi_utest_teardown_basic, NULL,
{
    xi_state_t state;
    ...
    xi_utest_setup_basic, xi_utest_teardown_basic, NULL,
{
    ...
    /* Call xi_connect_wikth_last_will after creating a  context */
    xi_context_handle_t xi_context = xi_create_context();
    tt_assert( XI_INVALID_CONTEXT_HANDLE < xi_context );
