...
XI_TT_TESTCASE( utest__xi_fs_dummy_stat__values_not_important,
                {
                    xi_fs_stat_t stat;
                    xi_state_t ret = xi_fs_stat( NULL, XI_FS_CONFIG_DATA,
                                                 "test_data", &stat );
...
XI_TT_TESTCASE( utest__xi_fs_dummy_open__values_not_important,
                {
                    ...
                    xi_state_t ret =
                        xi_fs_open( NULL, XI_FS_CONFIG_DATA, "test_data",
...
XI_TT_TESTCASE( utest__xi_fs_dummy_read__values_not_important,
                {
                    ...
                    xi_state_t ret = xi_fs_read( NULL, resource_handle, 0,
                                                 &buffer, &buffer_size );
...
XI_TT_TESTCASE( utest__xi_fs_dummy_write__values_not_important,
                {
                    ...
                    xi_state_t ret =
                        xi_fs_write( NULL, resource_handle, buffer, buffer_size,
                                     0, &bytes_written );
...
XI_TT_TESTCASE( utest__xi_fs_dummy_remove__values_not_important,
                {
                    xi_state_t ret = xi_fs_remove(
                        NULL, XI_FS_CONFIG_DATA, "test_name" );
