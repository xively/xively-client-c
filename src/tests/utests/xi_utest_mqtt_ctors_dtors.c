...
XI_TT_TESTCASE(
    utest__fill_with_puback_data__valid_data__puback_msg,
    {
        xi_state_t local_state = XI_STATE_OK;
        ...
        for ( ; i < 0xFFFF; ++i )
        {
            ...
            tt_want_int_op( memcmp( msg, msg_matrix, sizeof( xi_mqtt_message_t ) ), ==,
                            0 );
        }
...
XI_TT_TESTCASE(
    utest__fill_with_connect_data__valid_data__connect_msg,
    {
        xi_state_t local_state = XI_STATE_OK;
...
XI_TT_TESTCASE(
    utest__fill_with_publish_data__valid_data__publish_msg,
    {
        xi_state_t local_state = XI_STATE_OK;
...
XI_TT_TESTCASE( utest__fill_with_subscribe_data__valid_data__publish_msg,
                {
                    ...
                    tt_want_int_op( fill_with_subscribe_data( msg, topic, 17,
                                                              XI_MQTT_QOS_AT_LEAST_ONCE,
                                                              XI_MQTT_DUP_FALSE ),
                                    ==, XI_STATE_OK );
                    ...
                    tt_want_int_op( memcmp( msg->subscribe.topics->name->data_ptr, topic,
                                            sizeof( topic ) - 1 ),
                                    ==, 0 );
                    ...
                    tt_want_int_op(
                        memcmp( msg, msg_matrix, sizeof( xi_mqtt_message_t ) ), ==, 0 );
