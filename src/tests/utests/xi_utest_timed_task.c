...
void xi_utest_timed_task_callback_remove_timed_task( const xi_context_handle_t context_handle,
                                   const xi_timed_task_handle_t timed_task_handle,
                                   void* user_data )
{
...
XI_TT_TESTCASE( utest__add_timed_task__returns_valid_handle,
                {
                    ...
                    xi_timed_task_handle_t task_handle = xi_add_timed_task( container,
                                                                            dispatcher,
                                                                            context_handle,
                                                                            &xi_utest_timed_task_callback,
                                                                            0,
                                                                            0,
                                                                            NULL);
...
XI_TT_TESTCASE( utest__remove_timed_task__one_invocation_only_removes_one_task,
                {
                    ...
                    xi_timed_task_handle_t task_handle_1 = xi_add_timed_task( container,
                                                                            dispatcher,
                                                                            context_handle_1,
                                                                            &xi_utest_timed_task_callback,
                                                                            0,
                    ...
                    xi_timed_task_handle_t task_handle_2 = xi_add_timed_task( container,
                                                                            dispatcher,
                                                                            context_handle_2,
                                                                            &xi_utest_timed_task_callback,
                                                                            0,
...
XI_TT_TESTCASE( utest__remove_timed_task_inside_the_callback__wont_call_callback_after_remove,
                {
                    xi_utest_timed_task_reset_globals();
                    xi_evtd_instance_t* dispatcher = xi_evtd_create_instance();
                    xi_timed_task_container_t* container = xi_make_timed_task_container();
                    ...
                    xi_timed_task_handle_t task_handle = xi_add_timed_task( container,
                                                                            dispatcher,
                                                                            context_handle,
                                                                            &xi_utest_timed_task_callback_remove_timed_task,
                                                                            1,
                                                                            1,
                                                                            user_data);
