...
void xi_bsp_crypt_sha256_init( void** sha_ctx )
{
...
void xi_bsp_crypt_sha256_update( void* sha_ctx, const uint8_t* data, uint32_t len )
{
...
void xi_bsp_crypt_sha256_final( void* sha_ctx, uint8_t* out )
{
