...
{
    xi_static_vector_t* workerthreads;
 ...
 *
 * @param num_of_threads the desired number of threads, note: there is a maximum number of
 * threads
 */
 ...
 *
 * Destroys all worker threads in the pool, ensures all any-thread events are executed.
 * These
 * latters most probably on the caller thread of this destroy function (current thread).
 */
